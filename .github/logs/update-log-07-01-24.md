### Generated logs from GitHub Action: [9739141946](https://github.com/jacobbaungard/multicluster-observability-operator/actions/runs/9739141946)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240629013149-be42a89e84a7
...
- go: downloading github.com/aws/aws-sdk-go v1.54.11
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240629013149-be42a89e84a7), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240629013149-be42a89e84a7), but does not contain package github.com/openshift/hypershift/api/v1beta1
...
- go: all: module golang.org/x/tools@upgrade found (v0.22.0), but does not contain package golang.org/x/tools/internal/event/tag
